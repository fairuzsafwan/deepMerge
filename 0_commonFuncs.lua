...
function commonFuncs.obtainDataPath(benchmark, testPhase, lowestSize, dataset)
	...
	local dataFolderPath = paths.cwd() .. (not benchmark and '/Data/' .. dataset .. '/Datasets' or '/Data/benchmark/Datasets') --'/Data/nonbenchmark_ownCamPos/Datasets'
